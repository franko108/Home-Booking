...
echo form_open($action); ?>
	...
	<p><label for="booking_description"><?php echo lang('booking_description'); ?></label>                                
		<input id="booking_description" type="text" name="booking_description" value="<?php echo set_value('booking_description', $description); ?>"  />
	...
	<p><label for="booking_amount"><?php echo lang('booking_amount'); ?><span class="required"> *</span></label>                                
		<input id="booking_amount" type="text" name="booking_amount" value="<?php echo set_value('booking_amount', $amount); ?>"  />
	...
	<a href="javascript:void(0);" onclick="displayDatePicker('inputDate');"><img src="<?php echo base_url(); ?>/pictures/calendar.png" alt="calendar" border="0"></a>
		<input id="inputDate" type="text" name="inputDate" onclick="displayDatePicker('inputDate');" class="text" value="<?php echo set_value('booking_date', $inputDate); ?>"/>
	...
	<p><label for="inputGroup"><?php echo lang('booking_input'); ?></label> 
		<?php
			echo form_dropdown('inputGroup', $input_options, $default_input); 
		?>
	</p>
	<p>
